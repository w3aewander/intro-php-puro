...
<nav class="navbar navbar-expand-sm bg-navbar fixed-top">
  <div class="container-fluid">
    <a class="navbar-brand" href="#" data-target="inicio">APP</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="#" data-target="inicio">Início</a>
        </li>
        <li class="nav-item">
...
<script src="/js/dws.min.js"></script>
